...
# Install subversion and git including git-svn (to mirror svn repos onto a git remote)
RUN LC_ALL=C DEBIAN_FRONTEND=noninteractive apt-get install -y subversion git git-svn
